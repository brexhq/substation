...
var aggregateToStrTests = []struct {
	name     string
	cfg      config.Config
	data     []string
	expected []string
...
func TestAggregateToStr(t *testing.T) {
	ctx := context.TODO()
	for _, test := range aggregateToStrTests {

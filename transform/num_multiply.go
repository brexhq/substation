...
type numMultiply struct {
	conf     numMathConfig
	isObject bool
}

func newNumMultiply(_ context.Context, cfg config.Config) (*numMultiply, error) {
	conf := numMathConfig{}
...
func (tf *numMultiply) Transform(ctx context.Context, msg *message.Message) ([]*message.Message, error) {
...
func (tf *numMultiply) String() string {
	b, _ := json.Marshal(tf.conf)
	return string(b)
}

func (*numMultiply) Close(context.Context) error {
	return nil
}

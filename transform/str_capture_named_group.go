...
type strCaptureNamedGroupConfig struct {
...
func (c *strCaptureNamedGroupConfig) Decode(in interface{}) error {
	return iconfig.Decode(in, c)
}

func (c *strCaptureNamedGroupConfig) Validate() error {
...
type strCaptureNamedGroup struct {
	conf     strCaptureNamedGroupConfig
	isObject bool
}

func newStrCaptureNamedGroup(_ context.Context, cfg config.Config) (*strCaptureNamedGroup, error) {
	conf := strCaptureNamedGroupConfig{}
...
func (tf *strCaptureNamedGroup) Transform(_ context.Context, msg *message.Message) ([]*message.Message, error) {
...
func (tf *strCaptureNamedGroup) String() string {
	b, _ := json.Marshal(tf.conf)
	return string(b)
}

func (*strCaptureNamedGroup) Close(context.Context) error {
	return nil
}

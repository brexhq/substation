...
BUILD_DIR=$SUBSTATION_ROOT/examples/build/terraform/aws/s3/retry_on_failure
...
AWS_APPCONFIG_APPLICATION_NAME=substation AWS_APPCONFIG_PROFILE_NAME=retrier python3 build/scripts/aws/appconfig/appconfig_delete.py
